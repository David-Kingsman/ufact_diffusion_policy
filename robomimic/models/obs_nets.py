...
As an example, an observation could consist of a flat "robot_eef_pos" observation key,
...
def obs_encoder_factory(
    ...
    for k, obs_shape in obs_shapes.items():
        ...
        for obs_module, cls_mapping in zip(("core", "obs_randomizer"), (ObsUtils.OBS_ENCODER_CORES, ObsUtils.OBS_RANDOMIZERS)):
        ...
        if "pointcloud" in k:
            ...
            enc_kwargs["core_kwargs"] = {'input_dim': 6,
                                        'output_dim': 64,
